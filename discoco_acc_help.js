...
$(document).ready(function () {
	if(ds){
		...
		case 'ds_all_mp' :
			...
			$("#googleform").html('<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeRVhGlFuAcOjQ1fuRqMsLhj6Q2N_y7C1nCBOc_2BvyYSiRxg/viewform?embedded=true" width="640" height="500" frameborder="0" marginheight="0" marginwidth="0">載入中…</iframe>');
			$("#submit").val('我要中大獎');
			break;
		case 'ds_shanhua_mp' :
			...
			$("#googleform").html('<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScuTxdz9TaeY28iSCPWwgRY2T3hGNS1M7bpri2XnSfduQhVYw/viewform?embedded=true" width="640" height="500" frameborder="0" marginheight="0" marginwidth="0">載入中…</iframe>');
			$("#submit").val('我要中大獎');
			break;
		default:
