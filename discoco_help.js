$(document).ready(function () {
	...
	if(pgnme=='qrcode'){//this is for qrcode style
		$("#act-section").html(
			...
			+'<div id=\'qr02\'>'
			+'<div class="qr02_css1" style="height:0;padding:0 0 141% 0;background:#ba3939 url(\'https://i.imgur.com/1qSsI2A.jpg\') 0 0 no-repeat;-moz-background-size: cover;-webkit-background-size: cover;-o-background-size: cover;background-size: cover;">'
